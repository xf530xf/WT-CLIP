...
parser.add_argument("--config",
                    default='/data2/XF/KeYan/WTCLIP/configs/cod_attn_reg.yaml',
                    type=str,
                    help="config")
parser.add_argument("--work_dir", default="/data2/XF/KeYan/WTCLIP/results-cod", type=str, help="work_dir")
...
parser.add_argument("--model_path", default="/data2/XF/KeYan/WTCLIP/work_dir_voc/checkpoints/2024-12-20-00-45/WTCLIP_model_iter_28800.pth", type=str, help="model_path")
