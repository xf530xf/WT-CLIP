...
import numpy as np
import clip
from clip.clip_text import new_class_names, BACKGROUND_CATEGORY,new_class_names_cod,BACKGROUND_CATEGORY_COD
...
class WTCLIP(nn.Module):
    def __init__(self, num_classes=None, clip_model=None, embedding_dim=256, in_channels=512, dataset_root_path=None, device='cuda'):
        ...
        self.bg_text_features = zeroshot_classifier(BACKGROUND_CATEGORY_COD, ['a clean origami {}.'], self.encoder)
        self.fg_text_features = zeroshot_classifier(new_class_names_cod, ['a clean origami {}.'], self.encoder)
    ...
    def forward(self, img, img_names='2007_000032', mode='train'):
        ...
        for i, img_name in enumerate(img_names):
            ...
            # print("##############",cam_fts,cam_attn,seg_attn)
